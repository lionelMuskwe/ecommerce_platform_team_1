    ...
    <section id="about">
        <div class="about-1">
            ...
            <p>Welcome to Readers Republic! We are a team of book lovers dedicated to providing you with an unparalleled
                ...
                create this platform where you can easily browse, discover and purchase your favorite titles from the
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="about-item text-center">
                                ...
                                <p>Our mission is to provide a convenient and reliable online bookstore that offers an
                                    ...
                                    and engaging environment that inspires a love of reading and encourages personal
                        ...
                        <div class="col-md-4">
                            <div class="about-item text-center">
                                ...
                                <p>Our vision is to be the premier destination for book lovers everywhere, providing an
                                    ...
                                    recognized as the leading e-commerce bookstore offering a vast and diverse selection
                                    ...
                                    quality, reliability, and accessibility. Our goal is to inspire a love of reading and
                        ...
                        <div class="col-md-4">
                            <div class="about-item text-center">
                                ...
                                <h3>ACHIEVEMENTS</h3>
                                <hr>
                                <p>Some of our achievements include:</p>
                                <ul>
